...
const listModel = [
    ...
    // },
    {
        ...
        dateCreation: '06/11/2020',
        name: 'Đền Hùng',
        avatar: './avatars/den_hung.jpg',
        // urlModel: './models/yasuo_3rd_skin_edit.zip',
        urlModel: './models/locations/bao_tang_hung_vuong_phu_tho_viet_nam.zip',
        audio: './audios/yasuo.mp3',
        // urlBackground: './backgrounds/bg_lol/yasou.png',
        urlBackground: 'https://bizweb.dktcdn.net/100/111/770/products/du-lich-den-hung-7c9421f7-f611-4a85-a99d-38fca0077b65.jpg?v=1487222791917',
        views: '29',
        comments: 13,
        likes: 11,
        description: ''
