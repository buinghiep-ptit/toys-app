...
export const fetchGames = (params) => async dispatch => {
    try {
        ...
        [...results].map(res => res.backgroundImage && games.push({ ...res, modelUrl: "https://upload-test.foxpay.vn/media/file/inside/2021/01/15/12/league_of_legends_-_aatrox.zip" }))
